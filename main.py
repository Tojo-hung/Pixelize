...
for i in range(number_image):
  ...
  dirname = "C:/Users/xrace/Desktop/Pack 1 -- Portraits/image%d"%i
  os.mkdir(dirname)

  image_name = "C:/Users/xrace/Desktop/Pack 1 -- Portraits/image%d.png"%i
